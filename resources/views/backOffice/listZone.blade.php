...
@section('dashboard-content')
    ...
    <div class="page-content-wrapper p-xxl-4">
        ...
        <div class="row">
            <div class="col-12 mb-4 mb-sm-5">
                <div class="d-sm-flex justify-content-between align-items-center">
                    <h1 class="h3 mb-3 mb-sm-0">Zone List</h1>
        ...
        <div class="row g-3 align-items-center justify-content-between mb-5">
            <!-- Search -->
            <div class="col-md-12">
                <form class="rounded position-relative" method="GET" action="{{ route('backOffice.listZone') }}">
                ...
                <div class="col-md-6 col-lg-4 col-xxl-3">
                    <div class="card border h-100">
                        ...
                        <div class="card-body text-center pb-0">
                            ...
                            <!-- Title -->
                            <h5 class="mb-1">{{ $zone->nom }}</h5>
                            <small><i class="bi bi-person-badge me-1"></i>{{ $zone->adresse }}</small>
                            
                        </div>
                        <!-- card footer -->
                        <div class="card-footer d-flex gap-3 align-items-center">
                            <a href="{{ route('backOffice.detailZone', $zone->id) }}" class="btn btn-sm btn-primary-soft mb-0 w-100">View detail</a>
                           
                            <form action="{{ route('zone.delete', $zone->id) }}" method="POST">
                                    @csrf
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Add Zone</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="text-start" method="POST" action="{{ route('backOffice.addZone') }}">
                        @csrf
