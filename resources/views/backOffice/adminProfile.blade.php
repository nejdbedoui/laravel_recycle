            ...
            <div class="vstack gap-4">
                ...
                <div class="card border">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Form START -->
                        <form class="row g-3" method="post" action="{{ route('backOffice.adminProfile.update') }}" enctype="multipart/form-data">
                            @csrf
                            @method('patch')
                            ...
                            <div class="col-md-6">
                                ...
                                <x-text-input id="email" class="form-control" type="email" name="email" :value="old('email', $user->email)" required autocomplete="username" :disabled="true"/>
