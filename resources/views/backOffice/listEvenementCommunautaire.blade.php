...
@section('dashboard-content')
    ...
    <div class="page-content-wrapper p-xxl-4">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="list-inline-item dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end min-w-auto shadow rounded small"
                                            ...
                                            <li><a href="{{ route('backOffice.editEvenementCommunautaire', $evenement->id) }}" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#exampleModal2-{{ $evenement->id }}"><i
        ...
        <!-- Modal -->
        @foreach ($evenements as $evenement)
            <div class="modal fade" id="exampleModal2-{{ $evenement->id }}" tabindex="-1" aria-labelledby="exampleModalLabel-{{ $evenement->id }}" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel-{{ $evenement->id }}">Edit Community Events</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form class="text-start" method="POST"
