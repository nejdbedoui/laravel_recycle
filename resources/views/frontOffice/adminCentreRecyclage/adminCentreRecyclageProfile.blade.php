...
@section('dashboard-content')
    ...
    <section class="pt-0">
        <div class="container vstack gap-4">
            ...
            <div class="row">
                <div class="col-12">
                    <h1 class="fs-4 mb-0"><i class="bi bi-person fa-fw me-1"></i>My Profile</h1>
                </div>
            </div>
            <!-- Title END -->
                ...
                <div class="vstack gap-4">
                    ...
                    <div class="card border">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Form START -->
                            <form class="row g-3" method="post" action="{{ route('frontOffice.adminCentreRecyclageProfile.update') }}" enctype="multipart/form-data">
                                @csrf
                                @method('patch')
